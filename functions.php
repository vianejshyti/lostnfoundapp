...
class functions{
	public $link = null;
	public function __construct()//This is equivalent to functions()
	{
		$this->link = mysqli_connect("localhost","root","","projectdb");
	}
	...
	{
		$q = "DELETE FROM ".$tbl." WHERE itemid = ".$id;
		$result = $this->query($q);
	}
